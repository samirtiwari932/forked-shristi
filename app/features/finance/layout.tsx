  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f8f6f3] overflow-x-hidden touch-pan-y">
      ...
      <motion.div
        ...
        className="relative w-full bg-[#f1ede8] py-12 sm:py-16 lg:py-20 overflow-hidden"
      >
        <motion.div
          animate={{
            rotate: 360,
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-10 sm:left-20 w-32 h-32 sm:w-48 sm:h-48 bg-[#5d87ff]/5 rounded-full blur-2xl"
        />

        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            <motion.div variants={slideInLeft} className="lg:w-1/2 w-full">
              <motion.span
